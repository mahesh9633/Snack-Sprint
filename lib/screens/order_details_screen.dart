...
//             _isLoading = false;
//           });
//           debugPrint('ORDER_INFO comment => ${json['data']?['order_info']?['comment']}');
...
//     debugPrint('STATUS_CARD effectiveStatus="$effectiveStatus" isCancelled=$isCancelled comment="$comment"');
//
//     return Container(
//       decoration: BoxDecoration(
//         color: Colors.white,
