...
class CancelOrderApi {
  ...
  // ─── Request cancellation (goes to admin approval, not instant cancel) ───
  static Future<CancelOrderResult> requestCancellation({
    required String token,
    required String orderId,
    required String reason,
  }) async {
    final uri = Uri.parse(
      '$_kApiBase?route=groceries/categories.requestOrderCancellation'
          '&token=$token&api_token=$token',
    );
